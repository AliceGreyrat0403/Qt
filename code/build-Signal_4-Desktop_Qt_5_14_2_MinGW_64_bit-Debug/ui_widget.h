...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        pushButton->setGeometry(QRect(100, 20, 201, 81));
        pushButton_2 = new QPushButton(Widget);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(100, 140, 201, 81));
        pushButton_3 = new QPushButton(Widget);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));
        pushButton_3->setGeometry(QRect(100, 290, 201, 81));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        pushButton_3->setText(QCoreApplication::translate("Widget", "\350\256\276\347\275\256\346\226\207\346\234\2543\344\270\272\346\240\207\351\242\230", nullptr));
    } // retranslateUi
